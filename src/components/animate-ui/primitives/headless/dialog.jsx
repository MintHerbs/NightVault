// animate-ui "Headless Dialog" primitive, ported from
// https://animate-ui.com/docs/components/headless/dialog
// (registry item: primitives-headless-dialog).
//
// Ported from the upstream .tsx to .jsx — types stripped, behaviour
// unchanged — because docs/architecture-update.md §3.5 keeps src/ on plain
// JavaScript. Sourced per docs/rules.md §5.2 (check animate-ui first,
// vendor the source rather than depending on an opaque package).
